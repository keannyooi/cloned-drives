        ...
        async function editEvent(currentEvent, currentMessage) {
            ...
            switch (criteria) {
                ...
                case "extend":
                    ...
                    currentEvent.deadline = origDate.plus({
                        hours: time
                    }).toISO();
                ...
                case "addreq":
                    ...
                    switch (req) {
                        ...
                        case "rq":
                            ...
                            currentEvent.roster[index - 1].requirements[req] = {
                                start: start,
                                end: end
                            };
                        ...
                        case "trophies":
                            ...
                            if (rewardType === "money") {
                                ...
                                if (currentEvent.roster[index - 1].reward.trophies) {
                                    currentEvent.roster[index - 1].reward = {
                                        money: parseInt(amount),
                                        trophies: currentEvent.roster[index - 1].reward.trophies
                                    };
                                } else {
                                    currentEvent.roster[index - 1].reward = {
                                        money: parseInt(amount)
