    ...
    async execute(message, args) {
        ...
        async function getCar(user, currentMessage) {
            ...
            if (searchResults.length > 1) {
                ...
                const errorMessage = new Discord.MessageEmbed()
                    ...
                    .setDescription("Try checking his/her garage again.")
        ...
        async function changeTune(currentCar, origUpgrade, user, playerData, currentMessage) {
            ...
            const infoScreen = new Discord.MessageEmbed()
                ...
                .addFields({ name: "Gearing Upgrade", value: `\`${origUpgrade[0]} => ${upgrade[0]}\``, inline: true }, { name: "Engine Upgrade", value: `\`${origUpgrade[1]} => ${upgrade[1]}\``, inline: true }, { name: "Chassis Upgrade", value: `\`${origUpgrade[2]} => ${upgrade[2]}\``, inline: true })
                .setImage(racehud)
                .setTimestamp();
            message.client.execList.splice(message.client.execList.indexOf(message.author.id), 1);
            if (currentMessage) {
...
//# sourceMappingURL=changetune.js.map