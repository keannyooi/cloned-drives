            ...
            switch (criteria) {
                ...
                case "rq":
                    ...
                    infoScreen = new Discord.MessageEmbed()
                        ...
                        .addFields({ name: "Start", value: start, inline: true }, { name: "End", value: end, inline: true })
                        .setTimestamp();
                    break;
                case "driveType":
                case "bodyStyle":
                    ...
                    switch (criteria2) {
                        ...
                        case "tags":
                            if (!args[2]) {
                                ...
                                const errorMessage = new Discord.MessageEmbed()
                                    ...
                                    .setDescription("You are expected to provide the name of the criteria argument after the criteria name.")
                                    .setTimestamp();
                                return message.channel.send(errorMessage);
                            }
                            if (filter[criteria2.replace("C", "c")]) {
                                if (args[2].toLowerCase() === "all") {
                                    ...
                                    const errorMessage = new Discord.MessageEmbed()
                                        .setColor("#fc0303")
                                        .setAuthor(message.author.tag, message.author.displayAvatarURL({ format: "png", dynamic: true }))
                                        .setTitle("Error, 404 criteria argument not found.")
                        ...
                        default:
                            ...
                            const errorScreen = new Discord.MessageEmbed()
                                ...
                                .addField("Criteria Received", `\`${criteria2}\``)
                                .setTimestamp();
