    ...
    async execute(message, args) {
        ...
        if (!args[0]) {
            const infoScreen = new Discord.MessageEmbed()
                ...
                .addFields({
                    name: "Enable Graphics (ID: \`enablegraphics\`)",
                    value: `Having this set to \`false\` skips through all bot-generated graphics. Perfect for faster loading times.\n**Value:** \`${settings.enablegraphics}\``,
                    inline: true
                }, {
                    name: "Enable Daily Reward Notifications (ID: \`senddailynotifs\`)",
                    value: `Having this set to \`true\` enables automated DM notifications when your daily reward can be claimed.\n**Value:** \`${settings.senddailynotifs}\``,
                    inline: true
                }, {
                    name: "Enable Car List Filtering (ID: \`filtercarlist\`)",
                    value: `Having this set to \`true\` applies your current filter to the car list.\n**Value:** \`${settings.filtercarlist}\``,
                    inline: true
                }, {
                    name: "Enable Garage Filtering (ID: \`filtergarage\`)",
                    value: `Having this set to \`true\` applies your current filter to the garage.\n**Value:** \`${settings.filtergarage}\``,
                    inline: true
                }, {
                    name: "Show Black Market Cars (ID: \`showbmcars\`)",
                    value: `(This is WIP, doesn't do anything currently)\n**Value:** \`${settings.showbmcars}\``,
                    inline: true
                }, {
                    name: "Sorting Order For List Filtering (ID: \`sortingorder\`)",
                    value: `Lets you choose to sort either by ascending or descending. Affects the following commands: \`cd-garage, cd-carlist, cd-tracklist\`\n**Value:** \`${settings.sortingorder}\``,
                    inline: true
                }, {
                    name: "Unit Preference (ID: \`unitpreference\`)",
                    value: `Lets you choose the unit system of your preference. Graphics aren't affected by this setting. The game uses British units by default.\n**Value:** \`${settings.unitpreference}\``,
                    inline: true
                }, {
                    name: "Button Style (ID: \`buttonstyle\`)",
                    value: `Lets you choose the button style of your preference. \n**Value:** \`${settings.buttonstyle}\``,
                    inline: true
                }, {
                    name: "Shortened Lists (ID: \`shortenedlists\`)",
                    value: `Saves at least 450 characters from lists, allowing longer lists to be shown. Affects the following commands: \`cd-garage, cd-carlist\`\n**Value:** \`${settings.shortenedlists}\``,
                    inline: true
                })
                .setTimestamp();
