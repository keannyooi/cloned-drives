...
module.exports = {
    events: [
        { name: "Lightweight Showdown", desc: "placeholder." },
        { name: "BMW vs Mercedes", desc: "placeholder." },
        { name: "Porsche vs Mercedes", desc: "placeholder." },
        { name: "Alpina vs BMW", desc: "Son vs Father." },
        { name: "Mitsubishi vs Subaru", desc: "placeholder." },
        { name: "Honda vs Ferrari", desc: "placeholder." },
        { name: "Ford vs Ferrari", desc: "placeholder." },
        { name: "Porsche vs Tesla", desc: "placeholder." },
        { name: "Renault vs Citroen", desc: "placeholder." },
        { name: "Bugegg", desc: "Do you prefer Bugatti or Koenigsegg?" },
        { name: "Corvette Carshow", desc: "Pull out your foldable chairs and chill out with these vettes." },
        { name: "AWD Spotlight", desc: "Show off your best more-than-4 cards." },
        { name: "Boats out of Water", desc: "Bentley or Rolls-Royce, which is more boat?" },
        { name: "Dodge vs Ford", desc: "American muscle rivalry." },
        { name: "Convertible Coast Race", desc: "Wind in your hair on the open road." },
        { name: "Making Maybach Music", desc: "High-end Performance and Standard combined?" },
        { name: "Aston vs McOney", desc: "Prestige battle between 2 British icons." },
        ...
        { name: "Rally Raid", desc: "Time to test your High GC Offroad cards!" },
        ...
        { name: "Performance Excellence", desc: "Top-tier engineering on display." },
        { name: "Nissan vs Renault", desc: "Alliance rivalry showdown." },
        { name: "Charge of the Electric Brigade", desc: "The future is electric." },
        { name: "Porsche Collection", desc: "The best of Porsche engineering, or just some of the 900 other Porsches." },
        { name: "JLR vs the World", desc: "Jaguar Land Rover global challenge." },
        { name: "Concept Showcase", desc: "Futuristic prototypes hit the track." },
    ...
    boostedEvents: [
        ...
        { name: "Track Day Lover", desc: "Take your Track Day toys out on track." },
