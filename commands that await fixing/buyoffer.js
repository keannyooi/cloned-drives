        ...
        async function buyOffer(offer, currentMessage) {
            ...
            if (playerData.money >= offer.price) {
                ...
                const errorMessage = new Discord.MessageEmbed()
                    ...
                    .addFields({ name: "Required Amount of Money", value: `${moneyEmoji}${offer.price}`, inline: true }, { name: "Your Money Balance", value: `${moneyEmoji}${playerData.money}`, inline: true })
                    .setTimestamp();
                if (currentMessage) {
                    return currentMessage.edit(errorMessage);
                }
...
//# sourceMappingURL=buyoffer.js.map