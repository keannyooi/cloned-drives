    ...
    execute(message, args) {
        ...
        async function displayData(user, currentMessage) {
            ...
            const infoScreen = new Discord.MessageEmbed()
                ...
                .addFields({
                    name: "Money Balance",
                    value: `${moneyEmoji}${userData.money}`,
                    inline: true
                }, {
                    name: "Fuse Tokens",
                    value: `${fuseEmoji}${userData.fuseTokens}`,
                    inline: true
                }, {
                    name: "Trophies",
                    value: `${trophyEmoji}${userData.trophies}`,
                    inline: true
                }, {
                    name: "Total Cars in Garage",
                    value: totalCars,
                    inline: true
                }, {
                    name: "Total Maxed Cars in Garage",
                    value: maxedCarAmount,
                    inline: true
                }, {
                    name: "Maxed Car Percentage",
                    value: `${MCpercentage.toFixed(2)}%`,
                    inline: true
                }, )
                .setTimestamp();
            message.client.execList.splice(message.client.execList.indexOf(message.author.id), 1);
