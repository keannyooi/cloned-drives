    ...
    async execute(message, args) {
        ...
        if (isNaN(args[0]) || parseInt(args[0]) > playerData.money || parseInt(args[0]) > 1000000) {
            ...
            const errorMessage = new Discord.MessageEmbed()
                ...
                .addFields({ name: "Your Money Balance", value: `${moneyEmoji}${playerData.money}`, inline: true }, { name: "Amount You Are Trying to Bet", value: `${moneyEmoji}${args[0]}`, inline: true })
                .setTimestamp();
        ...
        if (interval.invalid !== null) {
            ...
            const intermission = new Discord.MessageEmbed()
                ...
                .addFields({ name: "Your Hand", value: playerList, inline: true }, { name: "Opponent's Hand", value: opponentList, inline: true })
