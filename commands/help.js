    ...
    execute(message, args) {
        ...
        if (!args.length || !isNaN(args[0])) {
            let infoScreen = new Discord.MessageEmbed()
                ...
                .addFields({ name: "Info", value: infoCommands.join(", ") }, { name: "Gameplay", value: gameplayCommands.join(", ") }, { name: "Configuration", value: configCommands.join(", ") }, { name: "Miscellaneous", value: miscCommands.join(", ") })
                .setTimestamp();
            ...
            const infoScreen = new Discord.MessageEmbed()
                ...
                .addFields({ name: "Aliases", value: aliases, inline: true }, { name: "Category", value: command.category, inline: true }, { name: "Cooldown", value: `${cooldown} second(s)`, inline: true }, { name: "Syntax", value: syntax }, { name: "Description", value: command.description })
                .setTimestamp();
            message.client.execList.splice(message.client.execList.indexOf(message.author.id), 1);
            return message.channel.send(infoScreen);
        }
