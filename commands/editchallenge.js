    ...
    async execute(message, args) {
        ...
        switch (criteria) {
            ...
            case "extend":
                ...
                challenge.deadline = origDate.plus({
                    hours: time
                }).toISO();
                infoScreen = new Discord.MessageEmbed()
                    .setColor("#03fc24")
            ...
            case "setcar":
                ...
                let rosterIndex = parseInt(args[1]),
                    deckPos = parseInt(args[2]);
            ...
            case "settune":
                ...
                let rosterIndex1 = parseInt(args[1]),
                    deckPos1 = parseInt(args[2]);
            ...
            case "addreq":
                ...
                switch (req) {
                    ...
                    case "rq":
                        ...
                        let isDupe = false;
                        for (let i = 0; i < challenge.roster[rosterIndex2 - 1].requirements.length; i++) {
                            if (challenge.roster[rosterIndex2 - 1].requirements[i][req] === {
                                    start: start,
                                    end: end
                                }) {
                                isDupe = true;
            ...
            case "settrack":
                ...
                let rosterIndex4 = parseInt(args[1]),
                    deckPos2 = parseInt(args[2]);
                    ...
                    case "trophies":
                        ...
                        if (rewardType === "money") {
                            ...
                            if (challenge.roster[index - 1].rewards.trophies) {
                                challenge.roster[index - 1].rewards = {
                                    money: parseInt(amount),
                                    trophies: challenge.roster[index - 1].rewards.trophies
                                };
                            } else {
                                challenge.roster[index - 1].rewards = {
                                    money: parseInt(amount)
