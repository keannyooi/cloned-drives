    ...
    async execute(message, args) {
        ...
        if (challenge.isActive || message.member.roles.cache.has("802043346951340064")) {
            ...
            let infoScreen = new Discord.MessageEmbed()
                ...
                .addFields({
                    name: "Hand",
                    value: lists.handString,
                    inline: true
                }, {
                    name: "Tracksets",
                    value: lists.trackString,
                    inline: true
                }, {
                    name: "Requirements",
                    value: lists.reqString,
                    inline: true
                }, {
                    name: "Rewards",
                    value: lists.rewardString,
                    inline: true
                })
            ...
            message.client.execList.splice(message.client.execList.indexOf(message.author.id), 1);
            let clMessage = await message.channel.send({
                embed: infoScreen,
                component: row
            });
