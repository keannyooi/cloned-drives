                ...
                switch (req) {
                    ...
                    case "rq":
                        ...
                        infoScreen = new Discord.MessageEmbed()
                            ...
                            .addFields({ name: "Start", value: start, inline: true }, { name: "End", value: end, inline: true }, { name: "Required Amount", value: `x${reqAmount}`, inline: true })
                            .setTimestamp();
                        break;
                    case "driveType":
                    case "bodyStyle":
...
//# sourceMappingURL=editchallenge.js.map