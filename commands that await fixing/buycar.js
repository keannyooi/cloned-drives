        ...
        async function buyCar(currentCar, amount, currentMessage) {
            ...
            if (playerData.money >= price && currentCar.stock >= amount) {
                ...
                const errorMessage = new Discord.MessageEmbed()
                    ...
                    .addFields({ name: "Required Amount of Money", value: `${moneyEmoji}${currentCar.price * amount}`, inline: true }, { name: "Your Money Balance", value: `${moneyEmoji}${playerData.money}`, inline: true }, { name: "Stock Remaining", value: currentCar.stock, inline: true })
                    .setTimestamp();
                if (currentMessage) {
                    return currentMessage.edit(errorMessage);
                }
