    ...
    execute(message, args) {
        ...
        if (!args.length) {
            ...
            const errorMessage = new Discord.MessageEmbed()
                ...
                .addFields({
                    name: "Calculating Handling",
                    value: "`cd-calculate handling (insert lateral g-force value here)`"
                }, {
                    name: "Calculating Mid-Range Acceleration (MRA)",
                    value: "`cd-calculate mra (insert 0-60mph time here) (insert 0-100mph time here)`"
                }, {
                    name: "Calculating Off-the-Line Acceleration (OLA)",
                    value: "`cd-calculate ola (insert 0-30mph value here) (insert 0-60 time here)`"
                }, {
                    name: "Averaging Numbers",
                    value: "`cd-calculate average (insert numbers here)`"
                })
                .setTimestamp();
            ...
            const errorMessage = new Discord.MessageEmbed()
                ...
                .addFields({
                    ...
                    name: 'Calculating Mid-Ranged Acceleration (MRA)',
                    value: '`cd-calculate mra (insert 0-60mph time here) (insert 0-100mph time here)`'
                }, {
                    name: 'Calculating Off-the-Line Acceleration (OLA)',
                    value: '`cd-calculate ola (insert 0-30mph value here) (insert 0-60 time here)`'
        ...
        const resultMessage = new Discord.MessageEmbed()
            ...
            .addFields({
                name: 'Calculating Handling',
                value: '`lateral g-force * 90`'
            }, {
                name: 'Estimating Handling',
                value: '`lateral g-force * 90`'
            }, {
                name: 'Calculating Mid-Ranged Acceleration (MRA)',
                value: '`100 * (0-60mph time / (0-100mph time - 0-60mph time))`'
            }, {
                name: 'Calculating Off-the-Line Acceleration (OLA)',
                value: '`100 * (0-30mph time / (0-60mph time / 2))`'
            }, {
                name: "Averaging Numbers",
                value: "`if you don't know that then your mafs bad`"
            })
            .setTimestamp();
        message.client.execList.splice(message.client.execList.indexOf(message.author.id), 1);
